...
void f1(u8 k[16], u8 rand[16], u8 sqn[6], u8 amf[2], u8 mac_a[8], u8 mk[8], u8 random_r[8]);
void f2345(u8 k[16], u8 rand[16], u8 res[8], u8 ck[16], u8 ik[16], u8 ak[6],u8 mk[8], u8 rk[8], u8 sk[8], u8 random_r[8]);
...
void f1(u8 k[16], u8 rand[16], u8 sqn[6], u8 amf[2], u8 mac_a[8], u8 mk[8], u8 random_r[8]) {
  ...
  Authentication_5gaka::RijndaelKeySchedule(mk);
...
Authentication_5gaka::RijndaelKeySchedule(ak);
  ...
  for (i = 0; i < 16; i++) rijndaelInput[i] = random_r[i] ^ op_c[i];
  Authentication_5gaka::RijndaelEncrypt(rijndaelInput, temp);
